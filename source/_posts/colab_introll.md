...
### Colab에서 메모장 사용하기
- [Colaboratory 개요](/images/source/images/colab_introllbasic_features_overview.ipynb)
- [Markdown 가이드](/images/source/images/colab_introllmarkdown_guide.ipynb)
- [라이브러리 가져오기 및 종속 항목 설치하기](/images/source/images/colab_introllsnippets/importing_libraries.ipynb)
- [GitHub에서 노트 저장 및 로드하기](https://colab.research.google.com/github/googlecolab/colabtools/blob/main/images/source/images/colab_introllcolab-github-demo.ipynb)
- [대화형 양식](/images/source/images/colab_introllforms.ipynb)
- [대화형 위젯](/images/source/images/colab_introllwidgets.ipynb)
- <img src="/img/new.png" height="20px" align="left" hspace="4px" alt="New"></img>
 [Colab의 TensorFlow 2](/images/source/images/colab_introlltensorflow_version.ipynb)

<a name="working-with-data"></a>
### 데이터로 작업하기
- [데이터 로드: 드라이브, 스프레드시트, Google Cloud Storage](/images/source/images/colab_introllio.ipynb) 
- [차트: 데이터 시각화하기](/images/source/images/colab_introllcharts.ipynb)
- [BigQuery 시작하기](/images/source/images/colab_introllbigquery.ipynb)
...
### 가속 하드웨어 사용하기
- [GPU를 사용한 TensorFlow](/images/source/images/colab_introllgpu.ipynb)
- [TPU를 사용한 TensorFlow](/images/source/images/colab_introlltpu.ipynb)
